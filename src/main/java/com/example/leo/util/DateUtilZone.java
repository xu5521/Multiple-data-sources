...
// e.printStackTrace();
    ...
    public static Date getJqDateTime(String time) {
        long lt = new Long(time);
        DateTime dateTime = new DateTime(lt);
        String s = dateTime.setTimeZone(TimeZone.getTimeZone("GMT+7:00")).toString("yyyy-MM-dd HH:mm:ss");
